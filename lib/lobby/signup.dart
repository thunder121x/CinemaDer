                  ...
                  child: SingleChildScrollView(
                                    ...
                                    String newVal = await getDownload();
                                      ...
                                      await FirebaseAuth.instance.createUserWithEmailAndPassword(
                                        ...
                                        password: profileModel.password
                                          ...
                                          .then((value) async{
                                            await FirebaseFirestore.instance.collection("customers").doc(FirebaseAuth.instance.currentUser!.uid).set({
                                              // "tickets_id" : [],
                                              "pocket_money" : 0,
                                          }).then((value){
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        child: Text('Sign In, Now',style: TextStyle(color: AppColor.secondaryColor,fontWeight: FontWeight.bold),),)
